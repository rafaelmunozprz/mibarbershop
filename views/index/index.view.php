                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="index.html"><img src="<?php echo $ROUTE ?>Library/plugin_public/img/logo/logo.png" alt=""></a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-5 col-sm-8">
                            <div class="single-footer-caption mb-50">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html"><img src="<?php $ROUTE ?>Library/plugin_public/img/logo/logo2_footer.png" alt=""></a>
                                </div>
